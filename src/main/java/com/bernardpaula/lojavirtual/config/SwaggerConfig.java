...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.bernardpaula.lojavirtual.resource"))
				.paths(PathSelectors.any()).build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API Loja Virtual",
		"Esta API é um exemplo feita por Bernard Paula",
		"Versão 1.0",
		"",
		new Contact("Bernard Paula", "bernardstudioart@gmail.com", "bernardstudioart@gmail.com"),
		"",
		"",
